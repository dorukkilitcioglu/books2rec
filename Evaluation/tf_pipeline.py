...
class BookEncoder:
    def __init__(self, input_dim, n_hidden = 100):
        ...
        with tf.variable_scope('decoder'):
            ...
            dec2 = tf.layers.dense(enc1, input_dim, activation = tf.nn.relu)
    ...
    def initialize(self, session):
        ...
        self.train_writer = tf.summary.FileWriter('.tmp/train', session.graph)
